    ...
    <div className="p-6">
      ...
      <div className="flex flex-col md:flex-row justify-between mb-6 gap-4">
        ...
        <div className="flex flex-col md:flex-row gap-2">
          <Link to="/enrollment/semester">
            <Button type="primary" icon={<PlusOutlined />} size="large">
              Create Semester
            </Button>
          </Link>
          <Link to="/enrollment/enroll">
        ...
        <Col xs={24} sm={12} lg={6}>
          <Card>
            ...
            <div style={{ color: "#3f8600", fontSize: "14px" }}>
              Active:{" "}
              {
                enrollmentDummyData.courses.filter((c) => c.status === "Active")
                  .length
              }
            </div>
          </Card>
        ...
        <Col xs={24} sm={12} lg={6}>
          <Card>
            ...
            <div style={{ color: "#3f8600", fontSize: "14px" }}>
              Open:{" "}
              {
                enrollmentDummyData.sections.filter((s) => s.status === "Open")
                  .length
              }
            </div>
          </Card>
            ...
            <p className="text-gray-600">
              {currentSemester ? (
                <>
                  ...
                  <Tag
                    color={
                      currentSemester.status === "Active" ? "green" : "blue"
                    }
                    className="ml-2"
                  >
