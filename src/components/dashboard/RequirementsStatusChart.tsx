...
interface RequirementsStatusChartProps {
  data: {
    signed: number;
    incomplete: number;
    missing: number;
...
const RequirementsStatusChart = ({ data }: RequirementsStatusChartProps) => {
  ...
  return (
    <Card title="Requirements Status Distribution" style={{ height: "100%" }}>
...
export default RequirementsStatusChart;
