...
interface MyStudentsByYearChartProps {
  data: {
    "1st Year": number;
    "2nd Year": number;
    "3rd Year": number;
...
const MyStudentsByYearChart = ({ data }: MyStudentsByYearChartProps) => {
  ...
  return (
    <Card title="My Students by Year Level" style={{ height: "100%" }}>
...
export default MyStudentsByYearChart;
